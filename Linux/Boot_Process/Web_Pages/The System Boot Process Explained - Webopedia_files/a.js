...
{return ioNumber;}}});QS.VendorBase=Backbone.Model.extend({clientModelClickName:'CLICK',clientModelPushName:'PUSH',clientModelPhoneName:'PHONE',displayUrlCTAString:'Visit',displayUrlCTADefault:'School Website',construct:function(dataListingJson,parentWidget)
...
{var self=this.data?this.data:this;return(!self.hasSiblings()&&self.isClickClient());},isLeadOnlyListing:function()
...
{this.trigger('QS.Vendor:populate:in',this);QS.VendorBase.prototype.populate.call(this,data);this.yellowRibbon=(typeof data['yellowRibbon']!=="undefined")?data['yellowRibbon']:null;this.gibill=(typeof data['gibill']!=="undefined")?data['gibill']:null;this.trigger('QS.Vendor:populate:out',this);},getListingAbbr:function()
...
qualificationList.sort();return _.uniq(qualificationList,true);}});QS.B2BVendor=QS.VendorBase.extend({construct:function(dataListingJson,parentWidget)
...
{return(this.data?this.data:this).vendorKey;}});QS.WidgetInstance=Backbone.Model.extend({sv_15:'BusinessListingWidget',sv_16:'siteName',sv_17:'pageUri',sv_18:'stateCode',sv_19:'countryCode',sv_20:'sp_261170',sv_21:'sp_loadAddlListingData',sv_22:'sp_261160',sv_23:'sp_260840',sv_24:'tracking',sv_25:'sp_260780',sv_26:'sp_260850',sv_27:'sp_260860',sv_28:'sp_261270',sv_29:'sp_261260',sv_30:'sp_261280',sv_31:'subj',sv_32:'sp_261290',sv_33:'DegreeOfInterest',sv_34:'AreaOfInterest',sv_35:'filterDlrByState',sv_36:'sp_270390',sv_37:'alphabet',sv_38:'gibill',sv_39:'sp_matched',sv_40:'sp_261250',sv_41:'yellowribbon',sv_42:'filterCriteria',sv_43:'dataValues',sv_44:'sp_260870',sv_45:'ClientModel',sv_46:'sp_260920',sv_5:'BLUID',sv_47:'bluids',sv_48:'ajaxLoadEffect',sv_49:'waitMessage',sv_50:'/getadditionaldata',sv_51:'/qsit',sv_52:'/qsct',sv_2:'http://hqx.qmp.quinstreet.com',sv_53:'numPrograms',sv_54:'numListings',sv_55:'numListingsPerPage',sv_56:'getAdditionalDealerData',sv_57:'contentService',sv_58:'getPageContent',sv_59:'Widget',sv_60:'Client',sv_61:'true',sv_62:'bluid_',sv_63:'WT_FPC',sv_64:'qsCookieTest',sv_65:'foobar',sv_66:10000,sv_67:5000,sv_68:5000,sv_3:10000,sv_69:300,sv_70:2000,sv_71:'none',sv_72:{},sv_73:null,sv_74:null,sv_75:null,sv_76:null,sv_77:'AreaOfInterest',sv_78:'DegreeOfInterest',sv_79:'Audience',sv_80:'PortalServiceCode',sv_81:'customParams',useOnPageWrapperKey:'useOnPageWrapper',optimizeForUserKey:'optimizeForUser',jsonVersion1_1:'1.1',categoryKeyEducation:5149,categoryKeyB2B:9258,categoryKeyHS:5151,categoryKeyMedical:9259,sv_82:'USERID_COOKIE',construct:function(domElement)
{eventProxy.bind(this);this.trigger('QS.WidgetInstance:construct:in',this);this.domElement=domElement;this.domId=domElement[0].id;this.sv_72=this.parseUrl();this.sv_83=this.sv_84(this.sv_16);this.sv_85=this.sv_84(this.sv_25);this.sv_86=this.sv_84(this.sv_17);this.sv_6=this.sv_84(this.sv_46);this.sv_14=this.sv_84(this.sv_53);this.sv_87=this.sv_84(this.sv_54);this.sv_88=this.sv_84(this.sv_40);this.sv_8=this.sv_84(this.sv_55);this.sv_89=this.sv_84(this.sv_18);this.sv_90=this.sv_84(this.sv_19);this.sv_91=this.sv_84(this.sv_20);this.sv_92=this.sv_84(this.sv_21);this.sv_93=this.sv_84(this.sv_22);this.sv_94=this.sv_84(this.sv_23);this.sv_95=decodeURIComponent(this.sv_84(this.sv_24));this.sv_96=this.sv_84(this.sv_26);this.sv_97=this.sv_84(this.sv_27);this.sv_98=this.sv_84(this.sv_44);this.sv_99=this.sv_84(this.sv_36);this.sv_100=this.sv_84(this.sv_28);this.sv_101=this.sv_84(this.sv_29);this.sv_102=this.sv_84(this.sv_30);this.sv_103=this.sv_84(this.sv_31);this.sv_104=this.sv_84(this.sv_32);this.sv_105=this.sv_84(this.sv_33);this.sv_106=this.sv_84(this.sv_34);this.sv_107=this.sv_84(this.sv_35);this.sv_108=this.sv_84(this.sv_37);this.sv_71=(this.sv_84(this.sv_48)==null)?'spinner':this.sv_84(this.sv_48);this.sv_1=this.sv_84(this.sv_49);this.sv_109=this.sv_84(this.sv_38);this.sv_110=this.sv_84(this.sv_41);this.sv_9=this.sv_84(this.sv_42);this.sv_10=this.sv_84(this.sv_43);this.sv_111=this.sv_84(this.sv_56);this.sv_112=this.sv_84(this.sv_45);this.sv_113=this.sv_84(this.sv_39);this.useOnPageWrapper=this.sv_84(this.useOnPageWrapperKey);this.optimizeForUser=this.sv_84(this.optimizeForUserKey);this.sv_114='/xapi';this.sv_115='/hqxapi';this.sv_116='/it';this.sv_117=this.sv_115+this.sv_116;this.sv_118=false;this.sv_119=null;this.sv_120=null;this.pageNumber='1';this.currentPage=0;this.pageSize='';this.sv_85=(this.sv_85===null)?'':this.sv_85;this.totalResults=0;this.sv_121=[];this.sv_122=[];this.programs=[];this.sv_4=false;this.setCtHandlers('.qsctCached');this.sv_123=null;this.sv_124=null;this.pages=null;this.sv_125=false;this.sv_126=false;this.sv_127=false;this.sv_12=false;this.sv_128='';this.sv_73='';this.sv_74='';this.sv_75='';this.sv_76='';this.sv_11='';this.jsonVersion=0;this.sv_129='userID';this.sv_130='';this.sv_131();this.trigger('QS.WidgetInstance:construct:out',this);},isAffiliate:function()
{return!!this.sv_119.getDataValues().AffiliateKey;},sv_131:function()
{if($.cookie(this.sv_82))
{this.sv_130=encodeURIComponent($.cookie(this.sv_82));}
if($.cookie(this.sv_63))
{this.sv_12=true;this.sv_11=$.cookie(this.sv_63);}
else
{$.cookie(this.sv_64,this.sv_65);this.sv_12=$.cookie(this.sv_64)==this.sv_65;$.cookie(this.sv_64,null);}},sv_84:function(key)
{if(typeof(this.sv_72[key])!=="undefined")
{return this.sv_72[key];}
else
...
{return(this.sv_111=='yes');},isRequestValid:function()
{return((this.sv_83!=null&&this.sv_86!=null&&this.sv_6!=null)||(this.sv_10!=null&&this.sv_9!=null));},populate:function(widgetJson)
{this.trigger('QS.WidgetInstance:populate:in',this);if($.isArray(widgetJson)&&(widgetJson[1]&&widgetJson[1].widgetInstance&&widgetJson[1].widgetInstance.contentType==this.sv_15&&widgetJson[1].widgetInstance.dataListingArr&&widgetJson[1].widgetInstance.dataListingArr.length>0)&&((this.sv_83!=null&&this.sv_86!=null&&this.sv_6!=null)||(this.sv_10!=null&&this.sv_9!=null)))
...
this.sv_118=true;var widgetInstance=widgetJson[1].widgetInstance;this.sv_6=widgetInstance.widgetInstanceKey;this.sv_120=widgetInstance.widgetInstanceName;this.pageNumber=widgetInstance.pageNumber;this.pageSize=widgetInstance.pageSize;this.totalResults=this.sv_122.length;_.each(widgetInstance.matchedServices,function(service)
{var matchedService=new QS.Service();matchedService.construct(service);this.sv_121.push(matchedService);},this);if(typeof widgetInstance.customParams!=="undefined")
{this.sv_128=widgetInstance.customParams;this.sv_73=(typeof widgetInstance.customParams.AreaOfInterest!=="undefined"?widgetInstance.customParams.AreaOfInterest:null);this.sv_74=(typeof widgetInstance.customParams.DegreeOfInterest!=="undefined"?widgetInstance.customParams.DegreeOfInterest:null);this.sv_75=(typeof widgetInstance.customParams.Audience!=="undefined"?widgetInstance.customParams.Audience:null);this.sv_76=(typeof widgetInstance.customParams.PortalServiceCode!=="undefined"?widgetInstance.customParams.PortalServiceCode:null);}
...
this.sv_124=this.sv_95;this.mergeSiblingVendors();this.pageNumber=widgetInstance.pageNumber;if(parseInt(widgetInstance.pageSize)>0)
{this.pageSize=parseInt(widgetInstance.pageSize);}
else if(this.getNumVendors()>0)
{this.pageSize=this.getNumVendors();}
else
{this.pageSize=1;}
this.totalResults=this.sv_122.length;this.populatePages();this.render();}
else
...
this.sv_118=false;this.displayAndExit();}
...
{var vendor=new QS.B2BVendor();vendor.construct(listing,this);this.sv_122.push(vendor);},this);},populateEducationVendors:function(dataListingArr)
{_.each(dataListingArr,function(listing)
{var vendor=new QS.Vendor();vendor.construct(listing,this);this.sv_122.push(vendor);},this);},populateHSVendors:function(dataListingArr)
{_.each(dataListingArr,function(listing)
{var vendor=new QS.HSVendor();vendor.construct(listing,this);this.sv_122.push(vendor);},this);},populateMedicalVendors:function(dataListingArr)
{_.each(dataListingArr,function(listing)
{var vendor=new QS.MedicalVendor();vendor.construct(listing,this);this.sv_122.push(vendor);},this);},mergeSiblingVendors:function()
{this.trigger('QS.WidgetInstance:mergeSiblingVendors:in',this);var lastPosition=-1,firstSibling=null,vendor=null,sv_132=[],vendorKeysToRemove={},i=0,length=0;if(_.isNumber(this.sv_122.length))
{for(length=this.sv_122.length;i<length;i++)
{vendor=this.sv_122[i];if(lastPosition!==vendor.position)
...
{for(i=0,length=this.sv_122.length;i<length;i++)
{vendor=this.sv_122[i];if(!vendorKeysToRemove[vendor.vendorKey])
{sv_132.push(vendor);}}
this.sv_122=sv_132;}}
...
{this.trigger('QS.WidgetInstance:updateWidget:in',this);this.sv_123=$('#'+this.domId+'_listing');if(this.isRequestValid())
{this.sv_119=new QS.XapiRequest();this.sv_119.setServiceName(this.sv_57);this.sv_119.setServiceMethod(this.sv_58);if(this.sv_9!=null)
{this.sv_119.setFilterCriteriaXml(this.sv_9);}
else
{this.sv_119.setFilterCriteria({sp_260880:this.sv_83,sp_260890:this.sv_86,sp_260910:this.sv_59,sp_260920:this.sv_6,sp_261250:this.sv_88});}
if(this.sv_10!=null)
{this.sv_119.setDataValuesXml(this.sv_10);if(this.optimizeForUser&&this.sv_130!=='')
{this.sv_119.setDataValue(this.sv_129,this.sv_130);}}
else
{this.sv_119.setDataValues({sp_260770:this.sv_61,sp_260780:this.sv_85,sp_260790:this.sv_60,sp_260800:this.pageNumber,sp_260810:this.pageSize,sp_260820:this.sv_89,sp_260830:this.sv_90,sp_261170:this.sv_91,sp_loadAddlListingData:this.sv_92,sp_260840:this.sv_94,sp_matched:this.sv_113,ClientModel:this.sv_112,sp_260850:this.sv_96,sp_260860:this.sv_97,sp_260870:this.sv_98,sp_270390:this.sv_99,sp_261270:this.sv_100,sp_261260:this.sv_101,sp_261280:this.sv_102,AreaOfInterest:(this.sv_106!=null)?this.sv_106:this.sv_103,DegreeOfInterest:(this.sv_105!=null)?this.sv_105:this.sv_104,filterDlrByState:this.sv_107,alphabet:this.sv_108,gibill:this.sv_109,yellowribbon:this.sv_110});}
this.trigger("QS.WidgetInstance:updateWidget:preAjax",this);$.ajax({url:this.sv_114,context:this,data:$.param(this.sv_119.getRequestObject()),processData:false,timeout:this.sv_67,success:this.populate,error:this.displayAndExit,cache:false});}
else
{this.displayAndExit();}
this.trigger('QS.WidgetInstance:updateWidget:out',this);},getVendors:function()
{return this.sv_122;},getNumVendors:function()
{return(this.data)?this.data.sv_122.length:this.sv_122.length;},getDealers:function()
{var dealers=[];_.each(this.sv_122,function(vendor)
{_.each(vendor.getDealers(),function(dealer)
{dealers.push(dealer)});});return dealers;},useXapiTracking:function()
{return(this.sv_95!==null);},getTrackingObj:function()
...
{var self=(this.data)?this.data:this;return self.sv_121;},getTag:function()
{if(this.sv_119.getDataValues().TAG)
{return this.sv_119.getDataValues().TAG;}
else if(this.sv_119.getDataValues().tag)
{return this.sv_119.getDataValues().tag;}
else
...
{if(theClass.substring(0,theWidget.sv_62.length)==theWidget.sv_62)
{bluid=theClass.substring(theWidget.sv_62.length);}});var destinationHref=ctElement.href;if(this.getVendors().length>0)
{var vendor=this.getVendorByBluid(bluid);if(vendor!=null)
{if((vendor.isClickClient()&&className!='.qsctSite')||((vendor.getClientModel()==vendor.clientModelClickName)&&!vendor.isMergedSibling()&&!vendor.hasSiblings()))
...
{var sv_7=$.parseJSON(decodeURIComponent(this.sv_95));if(sv_7.listing)
{_.each(sv_7.listing,function(listing)
{if(listing.namedValues[2].name==this.sv_5)
{bluids.push(listing.namedValues[2].value);}},this);}}
else
{_.each(this.sv_122,function(sv_133)
{bluids.push(sv_133.BLUID);bluids=bluids.concat(sv_133.getSiblingBluids());},this);}
...
{this.trigger('QS.WidgetInstance:restoreOnPageWidgetAndExit:in',this);this.removeUpdatedWidgetListing();this.sv_123.appendTo(this.domElement);this.sv_95=this.sv_124;this.setCtHandlers('.qsctCached');this.domElement.show();this.qsit(this.domElement);this.trigger('QS.WidgetInstance:restoreOnPageWidgetAndExit:out',this);return;},display:function()
...
{var whichPage=(pageNumber)?pageNumber:this.currentPage;var listingsData=this.sv_122;var page=[];var widgetPage=this.getWidgetPage(whichPage);if(widgetPage!=null)
...
{widget.currentPage=parseInt(this.className.replace('pageNumberLink',''));widget.sv_126=false;widget.sv_127=false;widget.render();}},nextPage:function(event)
{var widget=event.data.widget;if(widget)
{widget.currentPage++;widget.sv_126=false;widget.sv_127=false;widget.render();}},previousPage:function(event)
{var widget=event.data.widget;if(widget)
{widget.currentPage--;widget.sv_126=false;widget.sv_127=false;widget.render();}},lastPage:function(event)
{var widget=event.data.widget;if(widget)
{widget.currentPage=widget.pages.length-1;widget.sv_126=false;widget.sv_127=false;widget.render();}},firstPage:function(event)
{var widget=event.data.widget;if(widget)
{widget.currentPage=0;widget.sv_126=false;widget.sv_127=false;widget.render();}},keyNavigation:function(event)
...
{this.trigger("QS.WidgetInstance:getImpressionPixel:in",this);var sv_134=null,sv_135=null,bluids='',impressionPixel=$(),pixel=null,sv_136='';if(this.useXapiTracking())
{sv_136='y';var bluidArray=JSON.parse(decodeURIComponent(this.sv_84(this.sv_24)));if(_.isArray(bluidArray))
{bluids=bluidArray.join(',');}}
else
{sv_136='n';bluids=this.getImpressionBluids().join(',');}
if(bluids&&!this.getWidgetPage().impressionsLogged)
{pixel=document.createElement('img');impressionPixel=$(pixel);impressionPixel.attr('src',this.sv_117+'?'+$.param({ids:bluids,ca:sv_136,coo:(this.sv_12)?'y':'n'}))
...
{this.trigger('QS.WidgetInstance:render:in',this);if(this.sv_123!==null)
{this.sv_123.remove();}
...
{this.cloneableWrapperElem=this.sv_123.clone().empty();this.wrapperElem=this.cloneableWrapperElem.clone();this.wrapperElem.attr('id',this.domId+'_updated_listing');}
else
...
{renderedHeader=$.tmpl(this.domId+'_header_template',this);this.sv_126=true;}
else if((headerTemplate=$('#'+this.domId+'_header_template')).length>0&&!this.sv_126)
{renderedHeader=headerTemplate.tmpl(this);this.sv_126=true;}
if(typeof $.template[this.domId+'_footer_template']=="function")
{renderedFooter=$.tmpl(this.domId+'_footer_template',this);this.sv_126=true;}
else if((footerTemplate=$('#'+this.domId+'_footer_template')).length>0&&!this.sv_127)
{renderedFooter=footerTemplate.tmpl(this);this.sv_127=true;}
if(renderedHeader)
...
if(!this.sv_125)
{this.setKeyboardHandlers(wrapperElem);this.sv_125=true;}
...
this.sv_95=null;this.qsit(wrapperElem);if(this.updatedWidget&&this.wrapperElem&&this.updatedWidget[0])
...
{var self=this.data?this.data:this;return self.sv_71;},getJsonVersion:function()
{return this.jsonVersion;},isJsonVersion1_1:function()
{return true;},setMD:function(value)
{this.sv_91=value;return this;},setAFL:function(value)
{this.sv_96=value;return this;},setCT:function(value)
{this.sv_94=value;return this;},setDOI:function(value)
{this.sv_105=value;return this;},setPU:function(value)
{this.sv_86=value;return this;},setSC:function(value)
{this.sv_89=value;return this;},setFDBSY:function(value)
{this.sv_35=value;return this;},setEDV:function(value)
{this.sv_10=value;return this;},getCustomParam:function(param)
{var self=this.data?this.data:this;if(typeof param!=="undefined")
{if(typeof self.sv_128[param]!=="undefined")
{return self.sv_128[param];}}
