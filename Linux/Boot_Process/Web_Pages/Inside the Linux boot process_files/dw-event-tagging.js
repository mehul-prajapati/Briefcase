		...
		bindEventLinks: function () {
			...
			if (window.location.href.indexOf('topics') == -1) {
				...
				if (dojo.query("div.ibm-col-1-1 #dwc-exp-a").length > 0){
					dwOpp.ev(window.location.hostname, "display tile", "Jazzhub: Create project", window.location.href, "DWART", "Tile experiment");
				}		
				
				// A link
				dojo.query("div.ibm-col-1-1 #dwc-exp-a a").onclick(function(evt){
					dojo.stopEvent(evt);
					dwOpp.ev(window.location.hostname, this.href, "Jazzhub: Create project", window.location.href, "DWART", "Tile experiment");
					setTimeout(dojo.hitch(this, function(){window.location = this.href;}), 800);
				});
				...
				if (dojo.query("div.ibm-col-1-1 #dwc-exp-d").length > 0){
					dwOpp.ev(window.location.hostname, "display tile", "Codename BlueMix: Developers community.", window.location.href, "DWART", "Tile experiment");
				}		
				
				// D link
				dojo.query("div.ibm-col-1-1 #dwc-exp-d a").onclick(function(evt){
					dojo.stopEvent(evt);
					dwOpp.ev(window.location.hostname, this.href, "Codename BlueMix: Developers community.", window.location.href, "DWART", "Tile experiment");
					setTimeout(dojo.hitch(this, function(){window.location = this.href;}), 800);
				});
