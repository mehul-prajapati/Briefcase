         ...
         $(".prettyprint.tryit").click(function( e ) {
           ...
           if( X <= 36 && posY <= 16 ){
              ...
              if( window.innerWidth <= 768 ){
                 ...
                 $.colorbox({iframe:true, reposition:true, fixed:true,  opacity:.35, href:plugin.settings.url, width:w, height:h});
              }else{
                 var h = $(window).height();
                 h = 650;
                 $.colorbox({iframe:true, reposition:true, fixed:true,  opacity:.35, href:plugin.settings.url, width:960, height:h});
              }
           }
        });
      }
