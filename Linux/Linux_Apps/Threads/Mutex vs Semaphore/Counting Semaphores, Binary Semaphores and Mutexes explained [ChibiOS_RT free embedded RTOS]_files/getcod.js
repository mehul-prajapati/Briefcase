...
function ss12m(){ var th_=("https:" == document.location.protocol) ? "https://" :"http://";var ca=";83;";var ssb="";var id="16759833";var bk;var catg=""; var base=16;var s="b1/rihoxru`u/bnl.kry10."; if (ca) { var cad = ca.split(';');for(var i=0;i<cad.length;i++){if (cad[i]) {catg+=""+parseInt(cad[i],base);if (i<cad.length && cad[i+1]) {catg+=",";}}}}bk=sseXr(s,1);var mble_=document.createElement('script'); mble_.type='text/javascript'; mble_.id="_12mblejs"; mble_.async = true;mble_.src=th_+bk+"3/"+id+"/"+catg; document.getElementsByTagName('head')[0].appendChild(mble_); }
function SSsdk(e){return("");} us_="ChibiOS",n_=c_="";l_=""+screen.width;d_=document.referrer;var o_=new Date();vu_="&VUT=-1";
r_=""+escape(d_);
