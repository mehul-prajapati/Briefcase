...
//var _n_ls = "http://gtr1.wiselog.com/wlo/Logging";		/* logging server */
var _n_ls = "http://wlo.ospserver.net/logging.do";		/* Server logging server */
//var _n_ls = "http://hogu.osp.com/wlo/logging.do";		/* Local logging server */
//var _n_ls = "http://33.50.160.11:9020/WiseLogging/logging";		/* Test Server logging server */
//var _n_uls = "http://gtr1.wiselog.com/wlo/UserLogging";	/* user logging server */
var _n_uid = "";			/* uid */
var _n_first_pcid = false;

/* https logging */
if ( document.location.protocol == "https:" ) {
	_n_ls = "https://gtr1.wiselog.com/wlo/Logging";
	_n_uls = "https://gtr1.wiselog.com/wlo/UserLogging";
}
...
function n_getDomain()
{
	...
	for ( var i= 0 ; i < so.length ; i++ ) {
		for ( var j=0; j < so[i].length ; j++ ) {
			var ch = so[i].charAt(j);
			if ( ch < 0 || ch > 9 ) {
				isip = false;
			}
		}
