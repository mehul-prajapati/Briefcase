//document.title="bada Developers"; // title
if (document.title == "" || document.title == null) {
	document.title = "bada Developer - bada Developers";
}
...
// LeftMenu - APIS
function overLNBmenu(idx)
	{
		document.getElementById(idx).style.backgroundImage = 'url(http://static.bada.com/en_US/developer/apis/images/common/layout/bg_lnbon.gif)';
		document.getElementById(idx).style.backgroundColor='#154399';
	}
function outLNBmenu(idy)
	{
		document.getElementById(idy).style.backgroundImage = 'url(http://static.bada.com/en_US/developer/apis/images/common/layout/bg_lnboff.gif)';
		document.getElementById(idy).style.backgroundColor='#A9A9A9';
	}

// Add 2010_01_04 Developer Challenge
function tab_dc(n) {
	for(var i = 1; i < 6; i++) {
		obj = document.getElementById('tab_dc'+i);
		if ( n == i ) {
