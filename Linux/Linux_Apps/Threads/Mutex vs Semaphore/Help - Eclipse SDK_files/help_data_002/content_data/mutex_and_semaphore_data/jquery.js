...
(function($) {
	...
	$.fn.snippet = function(language,settings) {
		...
		/*********************************/
		/*eval("sh_languages." + language + "[0]").unshift([new RegExp("\\b(?:" + classnames.replace("-", "\\-").replace("[", "\\[").replace("]", "\\]") + ")\\b", "g"), "sh_styleFromXML", -1]);*/
		/********************************/
		...
		return this.each(function() {
			...
			if(node == "pre"){
				...
				if(!o.parent().hasClass("snippet-wrap")){
					...
					if(defaults.showNum){
						var newhtml = o.html();
						newhtml=newhtml.replace(/\n/g, "</li><li class='sh_li_for_codes'>");
						newhtml="<ol class='snippet-num'><li class='sh_li_for_codes'>"+newhtml+"</li></ol>";
						while(newhtml.indexOf("<li class='sh_li_for_codes'></li></ol>") != -1){
							newhtml=newhtml.replace("<li class='sh_li_for_codes'></li></ol>","</ol>");
						}		
					} 
					// build an unordered list if showNum is false
						...
						var newhtml = o.html();
						newhtml=newhtml.replace(/\n/g, "</li><li class='sh_li_for_codes'>");
						newhtml="<ul class='snippet-no-num'><li class='sh_li_for_codes'>"+newhtml+"</li></ul>";
						while(newhtml.indexOf("<li class='sh_li_for_codes'></li></ul>") != -1){
							newhtml=newhtml.replace("<li class='sh_li_for_codes'></li></ul>","</ul>");
						}
					}
...
//TEMPORARY ALTERED JAVASCRIPT SECTION THAT IS AN ALTERED COPY OF CPP
...
[
	[
		...
		[/\b(?:class|const|include|const_cast|delete|dynamic_cast|explicit|false|friend|inline|mutable|namespace|new|operator|private|protected|public|reinterpret_cast|static_cast|template|this|throw|true|try|typeid|typename|using|virtual)\b/g,"sh_keyword",-1],
		[/\/\/\//g,"sh_comment",1],
		[/\/\//g,"sh_comment",7],
		[/\/\*\*/g,"sh_comment",8],
		[/\/\*/g,"sh_comment",9],
		[/^[ \t]*#(?:[ \t]*include)/g,"sh_keyword",10,1],
		//[/^[ \t]*#(?:[ \t]*include)/g,"sh_preproc",7],

		/*
#include, use namespace, new, int, delete, const,  = #7F0055
<FLocales.h>, "MainForm.h", any string = 2A00FF
_pFrame, ID_BUTTON_CLEAR,  = 0000C0

*/
		
		/*[/^[ \t]*#(?:[ \t]*include)/g,"sh_preproc",10,1],
		[/^[ \t]*#(?:[ \t]*[A-Za-z0-9_]*)/g,"sh_preproc",-1],
		[/^[ \t]*#(?:include \&quot;[\w\W]*\&quot;)/g,"sh_comment",-1],
		[/^[ \t]*#(?:include[ \t]*[&]{1}quot[;]{1}[\w\W]*[&]{1}quot[;]{1})/g,"sh_comment",-1],*/
		
		[/(\bstruct)([ \t]+)([A-Za-z0-9_]+)/g,["sh_keyword","sh_normal","sh_classname"],-1],
		[/\b[+-]?(?:(?:0x[A-Fa-f0-9]+)|(?:(?:[\d]*\.)?[\d]+(?:[eE][+-]?[\d]+)?))u?(?:(?:int(?:8|16|32|64))|L)?\b/g,"sh_number",-1],
		[/"/g,"sh_string",13],
		[/'/g,"sh_string",14],
		/*[/&ldquo;[\w\W]*&rdquo;/g,"sh_string",13],
		[/&quot;[\w\W]*&quot;/g,"sh_string",13],*/
		[/\b(?:__asm|__cdecl|__declspec|__export|__far16|__fastcall|__fortran|__import|__pascal|__rtti|__stdcall|_asm|_cdecl|__except|_export|_far16|_fastcall|__finally|_fortran|_import|_pascal|_stdcall|__thread|__try|asm|auto|break|case|catch|cdecl|continue|default|do|else|enum|extern|for|goto|if|pascal|register|return|sizeof|static|struct|switch|typedef|union|volatile|while)\b/g,"sh_keyword",-1],
