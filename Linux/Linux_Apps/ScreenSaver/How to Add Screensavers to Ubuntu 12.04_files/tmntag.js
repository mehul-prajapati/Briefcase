...
tmntag.pubtargets.push(['_pgid', '7bff8c72']);
tmntag.pubtargets.push(['scat', ['i328','i360','i349','i350','i351']]);
tmntag.adtargets = [];
tmntag.markups=[];
...
googletag.cmd.push(function() {
	...
	if(typeof tmntag!='undefined' && typeof tmntag.su!='undefined' && tmntag.su===1 && typeof tmntag.l!='undefined') {
		googletag.pubads().set("page_url", tmntag.l);
	}
...
if (_comscoreID!='' && _comscoreID.indexOf('$')!=0) {
	...
	s.innerHTML = "setTimeout('COMSCORE.beacon({"+
		   ...
		   "c2:\""+_comscoreID+"\"," +
           "c3:\""+_comscoreID+"\"," +
           "c4:\"http://www.howtogeek.com/114027/how-to-add-screensavers-to-ubuntu-12.04/\"," +
           "c5:\"Technology - News\"," +
           "c6:\"\"," +
           "c15:\"\"" +
		   "});', 3000);";
