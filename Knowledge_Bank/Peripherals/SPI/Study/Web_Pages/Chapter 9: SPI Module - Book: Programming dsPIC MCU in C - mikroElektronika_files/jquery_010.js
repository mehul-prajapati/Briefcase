...
$(document).ready(function() {	 		
	...
	if ($('.box_wrapper').length){		
		//Intro annimation
		$('.bottom_part').css({left: 0, top: 450});		
		$('.bottom_panel').css({left: 0, top: 450});		
		$('.top_part').css({left: 0, top: -475});
				
		$('.bottom_part').delay(1000).animate({left: 0, top: 0}, 600);
		$('.bottom_panel').delay(1000).animate({left: 0, top: 0}, 600);
		$('.top_part').delay(1000).animate({left: 0, top: 0}, 600, function() {
			$('#home_ad img').removeClass('hide_content');
		});
		
		//Hover annimation
		$(".box_wrapper").hover(
			function () {
				$('.bottom_part').animate({left: 0, top: 100 }, 600);
				$('.bottom_panel').animate({left: 0, top: 100 }, 600);
				$('.top_part').animate({left: 0, top: -70 }, 600);		
			},
			function () {
				$('.bottom_part').animate({left: 0, top: 0}, 600);
				$('.bottom_panel').animate({left: 0, top: 0}, 600);
				$('.top_part').animate({left: 0, top: 0}, 600);
			}
		);	 	
	}	
